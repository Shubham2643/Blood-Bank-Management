...
import { facultyApi, hospitalApi } from "../../services/api.js";
  ...
  useEffect(() => {
    const fetchHospitalData = async () => {
      try {
        ...
        const profileRes = await facultyApi.getProfile();
        ...
        // Fetch blood stock
        const stockRes = await hospitalApi.getStock();
        const requestsRes = await hospitalApi.getRequests();

        const stockData = stockRes.data.data?.inventory || stockRes.data.data || [];
        const requestsData = requestsRes.data.data?.requests || stockRes.data.data?.requests || requestsRes.data.data || [];
